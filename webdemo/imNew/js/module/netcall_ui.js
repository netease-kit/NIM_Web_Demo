...
fn.switchViewPosition = function () {
    ...
    $bigView.prependTo($smallParent).addClass("smallView").removeClass("bigView").css({width: '160px', height: '120px'});
    $smallView.prependTo($bigParent).addClass("bigView").removeClass("smallView").css({width: '320px', height: '240px'});
